...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        solution.insertAtLast(23);
        solution.insertAtLast(13);
        solution.insertAtLast(32);
        solution.insertAtLast(43);
        solution.insertAtLast(2);
        solution.displayLinkedList(solution.first);
        Node temp = solution.reverse(3, solution.first);
        solution.displayLinkedList(temp);

    }

    public Node reverse(int k, Node obj){
        ...
        while(count<k && current!=null){
            ...
            if(f==null){
                ...
                Node curr = f;
                Node previous = null;
                while(curr!=null&&curr.data<current.data){
                    previous=curr;
                    curr=curr.next;
                }
                if(previous==null){
        ...
        getLast(f).next=reverse(k, current);

        return f;

    }

    public Node getLast(Node obj){
        Node current = obj;
