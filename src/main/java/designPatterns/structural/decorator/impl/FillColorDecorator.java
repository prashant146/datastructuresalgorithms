package designPatterns.structural.decorator.impl;

import designPatterns.creational.abstractfactory.com.one.color.Color;
import designPatterns.structural.decorator.Shape;
import designPatterns.structural.decorator.ShapeDecorator;
